...
Route::middleware('auth:api')->put('/updateuser', 'UserController@update');
Route::middleware('auth:api')->put('/changepassword', 'UserController@changePassword');
...
Route::get('inhalatorinformation', 'InhalatorInformationController@retrieve');
Route::get('choseninhalators', 'InhalatorInformationController@show');
